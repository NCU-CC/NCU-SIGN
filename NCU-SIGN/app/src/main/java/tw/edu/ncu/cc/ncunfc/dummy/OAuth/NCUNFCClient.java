    ...
    public static void refreshAccessToken(final Context context){
        ...
        queue.add(new StringRequest(Request.Method.POST, refreshURL,
            ...
            public Map<String, String> getParams() {
                ...
                mParams.put("client_id", context.getResources().getString(R.string.NCU_OAuth_Client_ID));
                mParams.put("client_secret", context.getResources().getString(R.string.NCU_OAuth_Client_Secret));
                return mParams;
            }
