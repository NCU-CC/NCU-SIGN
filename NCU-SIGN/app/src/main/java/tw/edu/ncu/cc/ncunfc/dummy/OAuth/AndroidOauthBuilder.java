...
public class AndroidOauthBuilder {
    ...
    //testing
    //private static final String AUTH_ENDPOINT_PATH  = "http://140.115.3.188/oauth/oauth/authorize";
    //private static final String TOKEN_ENDPOINT_PATH = "http://140.115.3.188/oauth/oauth/token";
    ...
    private AuthorizationUIController buildUIController() {
        ...
        DialogFragmentController retVal = new DialogFragmentController( fragmentManager ) {
            @Override
